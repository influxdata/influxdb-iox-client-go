...
type IoxMetadata struct {
	...
	// Unique sequencer ID.
	SequencerId int64 `protobuf:"varint,5,opt,name=sequencer_id,json=sequencerId,proto3" json:"sequencer_id,omitempty"`
	// Unique table ID.
	...
	TimeOfFirstWrite *timestamppb.Timestamp `protobuf:"bytes,10,opt,name=time_of_first_write,json=timeOfFirstWrite,proto3" json:"time_of_first_write,omitempty"`
	// Wallclock timestamp of when the last data in this file was received by IOx.
	TimeOfLastWrite *timestamppb.Timestamp `protobuf:"bytes,11,opt,name=time_of_last_write,json=timeOfLastWrite,proto3" json:"time_of_last_write,omitempty"`
	// The minimum sequence number from a sequencer in this parquet file.
	MinSequenceNumber int64 `protobuf:"varint,12,opt,name=min_sequence_number,json=minSequenceNumber,proto3" json:"min_sequence_number,omitempty"`
	...
	RowCount int64 `protobuf:"varint,14,opt,name=row_count,json=rowCount,proto3" json:"row_count,omitempty"`
...
func (x *IoxMetadata) GetSequencerId() int64 {
	if x != nil {
...
func (x *IoxMetadata) GetTimeOfFirstWrite() *timestamppb.Timestamp {
	if x != nil {
...
func (x *IoxMetadata) GetTimeOfLastWrite() *timestamppb.Timestamp {
	if x != nil {
...
func (x *IoxMetadata) GetMinSequenceNumber() int64 {
	if x != nil {
...
func (x *IoxMetadata) GetRowCount() int64 {
	if x != nil {
		return x.RowCount
	}
	return 0
...
var file_influxdata_iox_ingester_v1_parquet_metadata_proto_rawDesc = []byte{
	...
	0x22, 0xeb, 0x05, 0x0a, 0x0b, 0x49, 0x6f, 0x78, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	...
	0x0c, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x0b, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x72, 0x49, 0x64,
	0x12, 0x19, 0x0a, 0x08, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01,
	...
	,
...
var file_influxdata_iox_ingester_v1_parquet_metadata_proto_depIdxs = []int32{
	...
	3, // 1: influxdata.iox.ingester.v1.IoxMetadata.time_of_first_write:type_name -> google.protobuf.Timestamp
	3, // 2: influxdata.iox.ingester.v1.IoxMetadata.time_of_last_write:type_name -> google.protobuf.Timestamp
	1, // 3: influxdata.iox.ingester.v1.IoxMetadata.sort_key:type_name -> influxdata.iox.ingester.v1.SortKey
	2, // 4: influxdata.iox.ingester.v1.SortKey.expressions:type_name -> influxdata.iox.ingester.v1.SortKey.Expr
